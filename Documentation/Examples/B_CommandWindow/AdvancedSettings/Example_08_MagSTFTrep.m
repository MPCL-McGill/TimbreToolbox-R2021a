...
% =========================================================================
% 4. Change one or more settings of the MagSTFTrep.  
Reps.MagSTFTrep.winType         = 'hann';       % Window type
Reps.MagSTFTrep.winLength_s     = 0.04645;      % Window length - in seconds
Reps.MagSTFTrep.hopSize_s       = 0.04645/4;  	% Hop size in - seconds
% Reps.MagSTFTrep.winLength     = 2048;         % Window length - in samples
% Reps.MagSTFTrep.hopSize       = 512;          % Hop size - in samples
