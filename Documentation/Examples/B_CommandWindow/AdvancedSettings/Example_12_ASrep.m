...
% =========================================================================
% 4. Change one or more settings of the ASrep.  
Reps.ASrep.winLength_s     = 0.02;      % Window length - in seconds
Reps.ASrep.hopSize_s       = 0.01;      % Hop size - in seconds
% Reps.ASrep.winLength     = 1024;      % Window length - in samples
% Reps.ASrep.hopSize       = 512;    	% Hop size - in samples
