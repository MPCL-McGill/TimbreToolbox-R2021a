%==========================================================================
%  Runs the Timbre Toolbox's GUI for changing the Representation Settings. 
...
% Representations". The default representation settings can be changed in the 
% pop-up window. Once "Done" is clicked the selected representation will be
% ticked. 
