function MagSTFTrepSet(src,event)
...
btn = uibutton(fig, 'push', 'Text', 'Done', 'Position',[420, 20, 100, 22],...
        'ButtonPushedFcn',...
        @(btn,event) doneMagSTFTrep(src, winType, winLength_s, hopSize_s, winLength, hopSize));
...
function doneMagSTFTrep(src, winType, winLength_s, hopSize_s, winLength, hopSize)
    src.Checked = 'on';
