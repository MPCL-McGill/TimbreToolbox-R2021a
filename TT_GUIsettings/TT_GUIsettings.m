function  TT_GUIsettings
% GUI that allows to change the default values of representation settings.
...
itPowSTFTrep    = uimenu(mAudioReps,    'Text','PowSTFTrep...', 'Checked','off');
...
btnAnalyze = uibutton(fig,'push', 'Text', 'Analyze', ...
               ...
               'ButtonPushedFcn', @(btnAnalyze,event) get_UIsettings(...,
...
itTEErep.MenuSelectedFcn        = @TEErepSet;
itPowSTFTrep.MenuSelectedFcn    = @PowSTFTrepSet;
itMagSTFTrep.MenuSelectedFcn    = @MagSTFTrepSet;
itHARMrep.MenuSelectedFcn       = @HARMrepSet;
itERBrep.MenuSelectedFcn        = @ERBrepSet;
itASrep.MenuSelectedFcn         = @ASrepSet;
